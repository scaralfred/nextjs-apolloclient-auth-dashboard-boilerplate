    ...
    return (
      <div className={s.root}>
        ...
        <Row>
          <Col sm={6}>
            <Widget
              title={
                <div>
                  <div className="pull-right mt-n-xs">
                    {/* <Link href="/app/main" className="td-underline fs-sm">Options</Link> */}
                  </div>
            ...
            >
              <table className="table table-sm table-no-border mb-0">
                ...
                this.props.posts.map(post => (
                  <tr key={post.id}>
                    ...
                    <td>
                      {/* <Link href="/app/posts">{post.title}</Link> */}
                    </td>
                  </tr>
                ))}
                {/* {this.props.posts &&
              ...
              <div className="d-flex justify-content-end">
                {/* <Link href="/app/posts" className="btn btn-default">
          ...
          <Col sm={6}>
            <ListGroup>
              {/* <Link href="/app" className="list-group-item">

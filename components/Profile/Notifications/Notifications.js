...
class Notifications extends React.Component {
  ...
  render() {
    const {position} = this.state.options
    return (
          ...
          <Row>
            <Col lg="4" xs="12">
              ...
              <div className="location-selector">
                <div
                  className={cx("bit top left", position == "top-left" && "selected")}
                  onClick={() => this.toggleLocation('top-left')}
                />
                <div
                  className={cx("bit top right", position == "top-right" && "selected")}
                  onClick={() => this.toggleLocation('top-right')}
                />
                <div
                  className={cx("bit top center", position == "top-center" && "selected")}
                  onClick={() => this.toggleLocation('top-center')}
                />
                <div
                  className={cx("bit bottom left", position == "bottom-left" && "selected")}
                  onClick={() => this.toggleLocation('bottom-left')}
                />
                <div
                  className={cx("bit bottom right", position == "bottom-right" && "selected")}
                  onClick={() => this.toggleLocation('bottom-right')}
                />
                <div
                  className={cx("bit bottom center", position == "bottom-center" && "selected")}
                  onClick={() => this.toggleLocation('bottom-center')}
                />
              </div>
            </Col>
